...
public class NeuralNet {
    ...
    public void print() {
    	System.out.println("Inputs: "+input.size());
    	System.out.println("Outputs: "+output.size());
    	System.out.println("Hidden layers: "+hiddenLayer.size());
    	int i =0;
    	for (HiddenLayer hd : hiddenLayer) {
			System.out.println("Hidden layer "+i+" neurons "+hd.getNumberOfNeuronsInLayer());
		}
